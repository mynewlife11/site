  ...
  return (
    ...
    <main>
      ...
      <link
        ...
        />
      <title>Make it elf, enjoy yourself - ELFBAR</title>
      <meta name="description" content="Since 2018, ELFBAR has been making an effort on product innovation via a smart heating system as we discover the need for natural-based taste and more healthy ways of vaping are thriving year by year. To better control the formula and puff to transfer a repeatable experience to our customers, the products have been obedient to the keyword of ELFBAR: heathier and better. After thousands of taste and experiments, we found methods of making our products harm-free materials, pure taste and delicate design, only to present you products that will surely meet your demand." />
      <meta name="keywords" content="ELFBAR, electronic cigarette, e-cigarette, vaping product, disposable, elf, e-juice" />
    </Helmet>
        <Header id="home">
        <nav>
        <ul>
        ...
        <Section>
          <Container>
            <Column>
              <ImageWrap>
                <Image>
                <img src="./301.png" alt="nft_example" style={{ width: '720px', height: '670px', borderRadius: '30px',border: '5px solid #800000' }} />
                </Image>
              </ImageWrap>
            </Column>
            <Column>
              <Content>
                <CollectionName className="centered">ELFBAR SOLANA TRIP</CollectionName>
                <InfoRow>
                {guardStates.isStarted && wallet.publicKey && (
                  ...
                  <IconRow>
                    <a href="#" target="_blank" rel="noopener noreferrer" className="link1"><Twitter></Twitter></a>
                    <a href="#" target="_blank" rel="noopener noreferrer" className="link1"><Discord></Discord></a>
                  </IconRow>
                </InfoRow>
                <CollectionDescription>The Elfbar NFT collection presents a unique set of digital assets that are primarily designed for practical use in the real world. Each NFT in the collection has a clearly defined purpose and functionality, their value lies in their utility and uniqueness. We are opening a new world of solana for us, let's walk this path together and you will get invaluable experience and many valuable prizes.
